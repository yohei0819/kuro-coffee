...
export const products: Product[] = [
  {
    id: 'kuro-blend', name: '黒ブレンド', nameEn: 'KURO Blend',
    price: 1200, category: 'blend',
  ...
  {
    id: 'morning-light', name: '朝の光', nameEn: 'Morning Light',
    price: 1400, category: 'single-origin',
  ...
  {
    id: 'tsuki-blend', name: '月ブレンド', nameEn: 'Tsuki Blend',
    price: 1300, category: 'blend',
  ...
  {
    id: 'colombia-huila', name: 'コロンビア ウイラ', nameEn: 'Colombia Huila',
    price: 1500, category: 'single-origin',
  ...
  {
    id: 'yoru-decaf', name: '夜カフェインレス', nameEn: 'Yoru Decaf',
    price: 1400, category: 'decaf',
    description: 'カフェインレスでも妥協しない、深い味わい。',
    image: 'yoru-decaf.webp',
    taste: 'スイスウォータープロセスでカフェインを99.9%除去。それでもキャラメルのような甘みと、ほのかなシトラスの酸味をしっかりと感じられます。就寢前のリラックスタイムに最適です。',
    brewMethod: 'ペーパードリップがおすすめです。中挽き、湯温90℃、蒸らし30秒。ゆっくり3回に分けて注ぐことで、豆の風味を余すことなく引き出せます。',
  },
  {
    id: 'brazil-santos', name: 'ブラジル サントス', nameEn: 'Brazil Santos',
    price: 1100, category: 'single-origin',
